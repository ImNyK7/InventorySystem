                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="kodebrgklr" id="kodebrgklr" value="{{ old('kodebrgklr') }}" required class="form-control" style="width: 200px;">
                                    @error('kodebrgklr')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select id="stokbarang_id" name="stokbarang_id" required class="form-select" style="width: 200px;">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div style="display: flex; align-items: center;">
                                        <input type="number" name="jmlhbrgklr" id="jmlhbrgklr" value="{{ old('jmlhbrgklr') }}" required class="form-control" style="width: 100px; margin-right: 5px;">
                                        <select name="satuanbrg_display" id="satuanbrg_display" required class="form-select" style="width: 100px;" disabled>
                                            <option value="" selected></option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select id="kategori_id_display" name="kategori_id_display" required class="form-select" style="width: 140px;" disabled>
                                        <option value="" selected></option>
                        ...
                        <div class="col-md-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select id="customer_id" name="customer_id" required class="form-select" style="width: 200px; height: 30px;">
                                        <option value="" selected></option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" name="tanggalbrgklr" id="dateField" value="{{ old('tanggalbrgklr') }}" min="2015-01-02" max="2030-12-31" required class="form-control" style="width: 200px;">
                                    @error('tanggalbrgklr')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="hrgjual" id="hrgjual" value="{{ old('hrgjual') }}" required class="form-control" style="width: 200px;">
                                    @error('hrgjual')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
