...
<head>
    ...
    <title>Si Supras | List Barang Masuk</title>
</head>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="d-flex align-items-center">
                <h1 class="fs-3 m-4 mb-0">List Barang Masuk</h1>
            </div>
            
            <div class="container-fluid px-4">
                <div class="btn-wrapper wrapper">
                    <form action="/tambahbarangmasuk">
                        <button type="submit" class="btn"><i class="fa-solid fa-circle-plus" style="font-size: x-large"></i> <span style="padding-left: 5px">Tambah Barang Masuk</span></button>
                    </form>
                </div>
