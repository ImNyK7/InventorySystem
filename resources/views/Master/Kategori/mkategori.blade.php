...
<head>
    ...
    <title>SI SUPRAS | Master Kategori</title>
</head>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="btn-wrapper wrapper">
                    <form action="/tambahkategori">
                        <button type="submit" class="btn"><i class="fa-solid fa-circle-plus" style="font-size: x-large"></i> <span style="padding-left: 5px">Tambah Kategori</span></button>
                    </form>
                </div>
